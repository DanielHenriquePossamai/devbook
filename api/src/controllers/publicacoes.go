...
// BuscarPublicacoes traz as publicações para o feed do usuário
...
// BuscarPublicacao busca uma publicação em específico
...
// CurtirPublicacao curte a publicação de um usuário
...
// DescurtirPublicacao tira a curtida da publicação de um usuário
